"""
Author: Adya Shrivastava (as4003)
"""
import math
import heapq
import sys
...
class Terrain:
    ...
    def read_file(self):
        ...
        for i in range(len(file) -1):
            ...
            # self.pix_val[src[0], src[1]] = (253, 11, 11, 255)
            # self.pix_val[dest[0], dest[1]] = (253, 11, 11, 255)
    ...
    def output_path(self):
        ...
        self.im.save(self.output_image_filename)
        # self.im.show()
